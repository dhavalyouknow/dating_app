...
class _DogSwiperListState extends State<DogSwiperList> {
  ...
  Widget build(BuildContext context) {
    ...
    return SwipableStack(
      ...
      itemCount: widget.dogState.dogSwipes.length,
      ...
      builder: (c, p) {
        final itemIndex = p.index % widget.dogState.dogSwipes.length;
        return Column(
                  ...
                  Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: widget.showImageBig
                            ...
                            : ListView.builder(
                                ...
                                shrinkWrap: true,
                                itemCount: widget.dogState.dogSwipes[itemIndex]
                      ...
                      Padding(
                        ...
                        child: Text(
                          '${widget.dogState.dogSwipes[itemIndex].dogName}',
                          style: TextStyle(
                            fontSize: 23.sp,
                      ...
                      if (widget.swipeState.swipe[itemIndex].city.isNotEmpty)
                        Padding(
                          padding: EdgeInsets.symmetric(
                            horizontal: 15.w,
                          ),
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            ...widget.dogState.dogSwipes[itemIndex].lookingFor!
                                .map(
                                  (e) => Padding(
                      ...
                      child: AnimatedContainer(
                        ...
                        child: ClipRRect(
                          ...
                          child: widget.showImageBig
                              ...
                              : CachedNetworkImage(
                                  imageUrl: widget.dogState.dogSwipes[itemIndex]
